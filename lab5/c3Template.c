...
* Title: Lab5 - UDP client which has reliable data transfer with checksum, sequence number, acknowledgement number, and timer
* Description: This program implements a UDP client that sends packets with a checksum, sequence number, and acknowledgement number to a server. 
The client waits for an acknowledgement from the server and uses a timer to handle timeouts. The program simulates packet loss and handles retransmissions accordingly.
*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
